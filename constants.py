...
TEMPERATURE = 0.2
CHUNK_SIZE = 700       # 高橋_問2：initialize.pyのチャンクサイズを変数で定義
...
WEIGHTS_BM25 = 0.6       # 高橋_問題6:ハイブリッド検索用のBM25Retrieverの重み(0.0 ~ 1.0)
...
SUPPORTED_EXTENSIONS = {
    ".pdf": PyMuPDFLoader,
    ".docx": Docx2txtLoader,
    ### ".csv": lambda path: CSVLoader(path, encoding="utf-8"), # 高橋_問題6:csvファイルの読み込みなしへ
    ".txt": lambda path: TextLoader(path, encoding="utf-8")     # 高橋_問題5
}
